...
from django.urls import reverse  #change name to be routing
...
def index(request):
    ...
    if categ_id:
        # if category has value, then filtering
...
def cart_checkout(request):
    ...
    '''
    email = EmailMessage(subject=subject, body=body, to=['photographyref@gmail.com'])
